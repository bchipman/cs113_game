...
class Input:
    ...
    def _get_keyboard_pressed(self):
        ...
        self.kb_pressed['K_RETURN'] = sucky_kb_input[K_RETURN]
        self.kb_pressed['K_ESCAPE'] = sucky_kb_input[K_ESCAPE]
        self.kb_pressed['K_BACKQUOTE'] = sucky_kb_input[K_BACKQUOTE]
        self.kb_pressed['K_F12'] = sucky_kb_input[K_F12]
        self.kb_pressed['K_LEFT'] = sucky_kb_input[K_LEFT]
        self.kb_pressed['K_RIGHT'] = sucky_kb_input[K_RIGHT]
        self.kb_pressed['K_UP'] = sucky_kb_input[K_UP]
        self.kb_pressed['K_DOWN'] = sucky_kb_input[K_DOWN]
        self.kb_pressed['K_SPACE'] = sucky_kb_input[K_SPACE]
        self.kb_pressed['K_a'] = sucky_kb_input[K_a]
        self.kb_pressed['K_s'] = sucky_kb_input[K_s]
        self.kb_pressed['K_d'] = sucky_kb_input[K_d]
        self.kb_pressed['K_f'] = sucky_kb_input[K_f]
        self.kb_pressed['K_g'] = sucky_kb_input[K_g]
        self.kb_pressed['K_q'] = sucky_kb_input[K_q]
        self.kb_pressed['K_r'] = sucky_kb_input[K_r]
        self.kb_pressed['K_k'] = sucky_kb_input[K_k]
